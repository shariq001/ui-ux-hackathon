...
const Homefooter = () => {
  return (
    <div className='my:min-w-[1440px] bg-[#2a254b] text-white my:px-[100px] py-[16px] flex my:justify-between items-center sm:min-w-[390px] sm:px-[20px] sm:justify-center'>
