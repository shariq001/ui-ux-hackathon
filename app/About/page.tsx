...
const About = () => {
  ...
  return (
    <>
        ...
        {/* Section 3 */}
        <div className='my:min-w-[1440px] sm:min-w-[320px] flex justify-between my:flex-row items-center bg-[#f9f9f9] w-full sm:flex-col md:flex-row md:justify-center'>
        ...
        {/* Section 4 */}
        <div className='my:min-w-[1440px] sm:min-w-[320px] my:p-[100px] flex flex-col my:items-center gap-[50px] sm:px-[20px] sm:py-[50px] sm:items-start md:items-center'>
      ...
      {/* Section 6 */}
      <div className='my:min-w-[1440px] my:p-[100px] bg-[#2a254b] text-white flex justify-between my:flex-row w-full border-b-[2px] border-[#4e4d93] sm:px-[20px] sm:py-[50px] sm:flex-col sm:gap-[50px] md:flex-row md:flex-wrap'>
