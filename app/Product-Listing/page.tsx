...
const ProductListing = () => {
  ...
  return (
    ...
    {isVisible && (
        <div>
        {/* Promo */}
        <div className='bg-[#2a254b] my:min-w-[1440px] sm:min-w-[320px] text-white text-center flex justify-between items-center py-[10px] px-[30px] w-full'>
            <p></p>
    ...
    {/* Section 1 */}
    <div className='my:min-w-[1440px] flex sm:justify-center my:flex-row w-full my:items-center sm:flex-col sm:items-start md:flex-row lg:justify-between'>

        {/* Left */}
        <div>
            <Image src='/images/productimg1.png' width={721} height={759} alt='Product Image' className='sm:w-[390px] sm:h-[380px] my:w-[721px] my:h-[759px] md:w-[350px] md:h-[400px] lg:w-[500px] lg:h-[550px]'/>
        </div>
    ...
    <div className='my:min-w-[1440px] my:p-[100px] flex flex-col gap-[50px] sm:px-[20px] sm:py-[50px] md:px-[30px]'>
            ...
            {/* first */}
            <div>
              <h2 className='lg:text-[32px] clash text-[#2a254b] sm:text-[20px]'>You might also like</h2>
            </div>
            ...
            <div className='flex my:flex-row justify-between w-full text-[#2a254b] sm:flex-wrap'>
              ...
              {/* 1 */}
              <div className='flex flex-col gap-[10px] lg:w-[200px] sm:w-[163px] my:w-[305px]'>
                <Image src='/images/product1.png' width={305} height={375} alt='Product Card' className='sm:w-[163px] sm:h-[201px] lg:w-[200px] my:h-[375px] my:w-[305px]'/>
              ...
              {/* 2 */}
              <div className='flex flex-col gap-[10px] lg:w-[200px] sm:w-[163px] my:w-[305px]'>
                <Image src='/images/product2.png' width={305} height={375} alt='Product Card' className='sm:w-[163px] sm:h-[201px] lg:w-[200px] my:h-[375px] my:w-[305px]'/>
                <p className='text-[20px] clash'>Rustic Vase Set</p>
                <p className='text-[18px] satoshi'>&pound;155</p>
              </div>
    
              {/* 3 */}
              <div className='flex flex-col gap-[10px] lg:w-[200px] sm:w-[163px] sm:mt-[40px] md:mt-0 my:w-[305px]'>
                <Image src='/images/product3.png' width={305} height={375} alt='Product Card' className='sm:w-[163px] sm:h-[201px] lg:w-[200px] my:h-[375px] my:w-[305px]'/>
              ...
              {/* 4 */}
              <div className='flex flex-col gap-[10px] lg:w-[200px] sm:w-[163px] sm:mt-[40px] md:mt-0 my:w-[305px]'>
                <Image src='/images/product4.png' width={305} height={375} alt='Product Card' className='sm:w-[163px] sm:h-[201px] lg:w-[200px] my:h-[375px] my:w-[305px]'/>
    ...
    {/* Section 3 */}
    <div className='my:min-w-[1440px] my:p-[100px] flex flex-col my:items-center gap-[50px] sm:px-[20px] sm:py-[50px] sm:items-start md:items-center'>
    
            {/* first */}
            <div>
              <h2 className='clash my:text-[32px] text-[#2a254b] sm:text-[20px]'>What makes our brand different</h2>
            </div>
    
            {/* Second */}
            <div className='flex my:justify-between lg:flex-row w-full my:items-center sm:flex-col sm:items-start sm:gap-[50px] md:items-center '>
    
              {/* 1 */}
              <div className='flex flex-col gap-[15px] sm:w-[270px] md:w-[400px] sm:items-start md:items-center text-center text-[#2a254b]'>
    ...
    {/* Section 4 */}
    <div className=' my:min-w-[1440px] my:p-[50px] bg-[#f9f9f9] sm:px-[0px] md:px-[30px] sm:my-[30px] my:my-0 '>
        <div className='bg-white my:p-[100px] text-[#2a254b] flex flex-col my:items-center gap-[16px] sm:px-[20px] sm:items-start md:py-[30px] md:items-center'>
          ...
          <div className='flex my:w-[472px] h-[56px] justify-center items-center mt-[50px] sm:w-full'>
            <input type="email" placeholder='your@email.com' className='sm:w-[200px] md:w-[300px] bg-[#f9f9f9] p-[16px] rounded-[5px] lg:w-[400px]'/>
    ...
    {/* Section 5 */}
    <div className='my:min-w-[1440px] my:p-[100px] bg-[#2a254b] text-white flex my:flex-row justify-between w-full border-b-[2px] border-[#4e4d93] sm:px-[20px] sm:py-[50px] sm:flex-col sm:gap-[50px] md:flex-row md:flex-wrap'>
